...
exports.buildPropertyApprovalEmail = buildPropertyApprovalEmail;
/**
...
function buildWelcomeEmail(to, name) {
    ...
    const html = wrap(subject, `<p>Hi ${name},</p><p>Welcome to RentIt! Your account is ready. Start browsing listings or list your own property whenever you're ready.</p>`);
    return { to, subject, text, html };
}
function buildPropertyApprovalEmail(to, ownerName, propertyTitle) {
    ...
    const html = wrap(subject, `<p>Hi ${ownerName},</p><p>Great news -- <strong>${propertyTitle}</strong> has been reviewed and approved. It's now live and visible to renters.</p>`);
    return { to, subject, text, html };
}
