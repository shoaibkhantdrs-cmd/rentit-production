...
export class InMemoryPropertyRepository implements IPropertyRepository {
  ...
  async create(data: NewProperty): Promise<Property> {
    ...
    const property: Property = {
      ...
      frontWidthFt: data.frontWidthFt ?? null,
      shopDepthFt: data.shopDepthFt ?? null,
      roadWidthFt: data.roadWidthFt ?? null,
      powerLoad: data.powerLoad ?? null,
      isCornerShop: data.isCornerShop ?? null,
      hasWashroom: data.hasWashroom ?? null,
      readyToMove: data.readyToMove ?? null,
