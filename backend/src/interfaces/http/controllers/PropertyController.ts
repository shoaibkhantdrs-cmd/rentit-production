...
export class PropertyController {
  ...
  search = async (req: Request, res: Response): Promise<void> => {
    ...
    const result = await this.searchProperties.execute({
      ...
      frontWidthMin: query.frontWidthMin,
      roadWidthMin: query.roadWidthMin,
      readyToMove: query.readyToMove,
      isCornerShop: query.isCornerShop,
      hasWashroom: query.hasWashroom,
